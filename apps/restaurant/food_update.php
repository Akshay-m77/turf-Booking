<?php
	...
	$Log_Id=$_SESSION['SESS_RESTAURANT_ID'];
?>	
<!DOCTYPE html>
<html>
                ...
                <div class="box-body no-padding">
                	<div class="panel panel-primary">
                        <div class="panel-heading">
                        	All Food Details Update
                        </div>
                        <div class="panel-body">                            
                       <!-- Col Start -->
                       <?php
                        $result = $db->prepare("select * from food where Log_Id='$Log_Id'");
                        $result->execute();
                              ...
                              <div class="box box-widget widget-user">
                                ...
                                <div class="box-footer">
                                  <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                      <div class="description-block">
                                      <a href="food_update_edit.php<?php echo '?turfrid='.$turfrid; ?>" class="btn btn-block btn-primary">Update</a>
                                      </div>
                                      <!-- /.description-block -->
                                    </div>
                                    <!-- /.col -->
