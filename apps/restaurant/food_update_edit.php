                ...
                <div class="box-body no-padding">
                	<div class="panel panel-primary">
  					  <div class="panel-heading ">
                            ...
                            <form method="post" action="action/food_update.php" enctype="multipart/form-data" autocomplete="off">
                                   ...
                                   <div class="alert" style="padding:5px; background-color:#3399cc; color:white">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                     ...
                                     <div class="col-md-6 col-sm-6 col-xs-12">
										...
										<input type="number"  name="rate"  class="form-control" value="<?php echo $rate?>">
									</div>	 
                                      <div class="col-md-6 col-sm-6 col-xs-12">
