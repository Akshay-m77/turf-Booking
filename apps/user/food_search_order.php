<?php
	...
	$result = $db->prepare("select * from food where turfrid='$turfrid'");
	$result->execute();
	for($i=0; $row = $result->fetch(); $i++)
	{
		$SLog_Id = $row['Log_Id'];
              ...
              <div class="box box-danger">            
                <div class="box-body no-padding">
                	<div class="panel panel-primary">
                       ...
                       <!-- Col Start -->
                      <form method="post" action="action/order_food.php" class="forms" autocomplete="off" enctype="multipart/form-data"> 
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12" style="float:right">
                         <div class="col-xs-6 pull-right">
                            ...
                            <br>
                               <a type="button" class="btn btn-primary pull-right m_t_1"  href="food_search.php">
