                            ...
                            <div class="main-menu">
                                <nav class="rs-menu">
                                    <ul class="nav-menu">                                       
                                        ...
                                        <li><a href="apps//index.php">Shops</a></li>
                                        <li><a href="apps/index.php">Restaurants</a></li>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="slider-text text-center">
                                        <h1 data-animation-in="slideInDown" data-animation-out="animate-out slideOutUp">Soccer Club<span>VS</span>Victoria SC</h1>
                                        <div data-animation-in="slideInLeft" data-animation-out="animate-out fadeOut" class="CountDownTimer" data-date="2020-03-31 00:00:00"></div>
					        	...
					        	<div class="latest-news-slider">
					        		<div>
										<div class="news-normal-block">
					                    	...
					                    	<h4 class="news-title"><a href="">TFC Club Score Seven in CL Rout Match</a></h4>
					                    	<div class="news-desc">
					                    		<p>
							...
							<div class="today-match-teams text-center">
                                ...
                                <div class="recent-match-results">
                                    ...
                                    <div class="view-all-result">
                                        <a href="#">View All <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
                                    </div>
                                </div>
							</div>
						</div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="point-list text-center">
                            ...
                            <a class="view-more text-left" href="#">View More <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
			</div>
				...
				<div class="row">
					...
					<div class="col-md-4 latest-news">
						<div class="inner-news small-news">
							<div class="news-img">
								<a href=""><img src="images/latest-video/1.jpg" alt="News" /></a>
							</div>
							<div class="news-text">
								<h5><a href="">Badda FC vs Banni FC Highlights 1-1</a></h5>
						...
						<div class="inner-news small-news">
							<div class="news-img">
								<a href=""><img src="images/latest-video/2.jpg" alt="News" /></a>
							</div>
							<div class="news-text">
								<h5><a href="">Badda FC vs Banni FC Highlights 1-1</a></h5>
								<span class="date">May 30, 2017</span>
						...
						<div class="inner-news small-news">
							<div class="news-img">
								<a href=""><img src="images/latest-video/3.jpg" alt="News" /></a>
							</div>
							<div class="news-text">
								<h5><a href="">Badda FC vs Banni FC Highlights 1-1</a></h5>
								<span class="date">May 30, 2017</span>
                        ...
                        <div class="rs-carousel owl-carousel" data-loop="true" data-items="3" data-margin="30" data-autoplay="true" data-autoplay-timeout="7000" data-smart-speed="2000" data-dots="false" data-nav="false" data-nav-speed="false" data-mobile-device="1" data-mobile-device-nav="false" data-mobile-device-dots="false" data-ipad-device="2" data-ipad-device-nav="false" data-ipad-device-dots="false" data-ipad-device2="2" data-ipad-device-nav2="false" data-ipad-device-dots2="false" data-md-device="3" data-md-device-nav="false" data-md-device-dots="false">
                            <div class="our-team">
                                ...
                                <div class="person-details">
                                    <div class="overly-bg"></div>
                                    <a href="#"><h5 class="person-name">Eyamin Hossain</h5></a>
                            ...
                            <div class="our-team">
                                ...
                                <div class="person-details">
                                    <div class="overly-bg"></div>
                                    <a href="#"><h5 class="person-name">Istiak Ahmed</h5></a>
                                    <table class="person-info">
                                        <tbody>
                                            <tr>
                                                 <td>Born</td>
                            ...
                            <div class="our-team">
                                ...
                                <div class="person-details">
                                    <div class="overly-bg"></div>
                                    <a href="#"><h5 class="person-name">Masud Rana</h5></a>
                                    <table class="person-info">
                                        <tbody>
                                            <tr>
                                                 <td>Born</td>
                            ...
                            <div class="our-team">
                                ...
                                <div class="person-details">
                                    <div class="overly-bg"></div>
                                    <a href="#"><h5 class="person-name">Forhad Ali</h5></a>
                                    <table class="person-info">
                                        <tbody>
                                            <tr>
                                                 <td>Born</td>
                            ...
                            <div class="our-team">
                                ...
                                <div class="person-details">
                                    <div class="overly-bg"></div>
                                    <a href="#"><h5 class="person-name">Mahabub Alam</h5></a>
                                    <table class="person-info">
                                        <tbody>
                                            <tr>
                                                 <td>Born</td>
                            ...
                            <div class="our-team">
                                ...
                                <div class="person-details">
                                    <div class="overly-bg"></div>
                                    <a href="#"><h5 class="person-name">Abdur Rashid</h5></a>
                                    <table class="person-info">
                                        <tbody>
                                            <tr>
                                                 <td>Born</td>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="recent-post-widget">
                                <div class="post-item">
                                    ...
                                    <div class="post-desc">
                                        <h5 class="post-title"><a href="">Welcome to Soccer Template</a></h5>
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            <div class="copyright">
                                <p>&copy; 2022 <a href="#" target="_blank">Turf Finding</a>. All Rights Reserved.</p>
                            </div>
                        </div>
